...
exports.createEmptyTodo = async function (req, res) {
  try {
    ...
    const todoCreated = await todoServices.createEmptyTodo(todo)
...
exports.findAllTodos = async function (req, res) {
  try {
    ...
    const todos = await todoServices.findAllTodos(paginationSettings)
...
exports.findTasksFromTodoId = async function (req, res) {
  try {
    ...
    const todos = await todoServices.findTasksFromTodoId(searchData)
    res.status(200).send(todos)
  } catch (e) {
    res.status(ErrorHandler(e)).send(e)
  }
...
exports.deleteTodoFromID = async function (req, res) {
  try {
    ...
    const response = await todoServices.deleteTodoFromID(id)
...
exports.updateEntireTodoFromID = async function (req, res) {
  try {
    ...
    const response = await todoServices.updateEntireTodoFromID(toEdit)
...
exports.toggleTodoFromID = async function (req, res) {
  try {
    ...
    const response = await todoServices.toggleTodoFromID(+idToToggle)
    res.status(200).send(response)
  } catch (e) {
    res.status(ErrorHandler(e)).send(e)
  }
